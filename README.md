...
A minimal Minecraft launcher with GUI support.

This project is a fork of [cmd-launcher](https://github.com/telecter/cmd-launcher) by telecter, licensed under MIT. The original project has been modified to add GUI functionality while maintaining and enhancing all CLI features.
EN | [DE](README_de.md)
...
1. Clone the repository: `git clone https://github.com/dilllxd/theboyslauncher`
