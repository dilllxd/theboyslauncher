...
// PackwizInfo contains information about a packwiz modpack
type PackwizInfo struct {
	URL     string `toml:"url,omitempty" json:"url,omitempty"             comment:"URL to the pack.toml file"`
	Version string `toml:"version,omitempty" json:"version,omitempty"     comment:"Current version of the modpack"`
	Name    string `toml:"name,omitempty" json:"name,omitempty"           comment:"Name of the modpack"`
	Author  string `toml:"author,omitempty" json:"author,omitempty"       comment:"Author of the modpack"`
}
...
func CreateInstance(options InstanceOptions) (Instance, error) {
	...
	// Set sensible defaults for window resolution if not specified
	if inst.Config.WindowResolution.Width == 0 && inst.Config.WindowResolution.Height == 0 {
		inst.Config.WindowResolution.Width = 1708
		inst.Config.WindowResolution.Height = 960
	}
