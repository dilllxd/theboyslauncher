...
Ein minimalistischer Minecraft Launcher mit GUI-Unterstützung.

Dieses Projekt ist ein Fork von [cmd-launcher](https://github.com/telecter/cmd-launcher) von telecter, lizenziert unter MIT. Das Originalprojekt wurde modifiziert, um GUI-Funktionalität hinzuzufügen, während alle CLI-Funktionen erhalten bleiben.
[EN](README.md) | DE

[![Build](https://github.com/dilllxd/theboyslauncher/actions/workflows/build.yml/badge.svg)](https://github.com/dilllxd/theboyslauncher/actions/workflows/build.yml)
![GitHub go.mod Go version](https://img.shields.io/github/go-mod/go-version/dilllxd/theboyslauncher)
[![Go Reference](https://pkg.go.dev/badge/github.com/dilllxd/theboyslauncher.svg)](https://pkg.go.dev/github.com/dilllxd/theboyslauncher)
...
```bash
go install github.com/dilllxd/theboyslauncher@latest
```

### Aus Sourcecode

1. Repository klonen: `git clone https://github.com/dilllxd/theboyslauncher`
...
```sh
theboyslauncher inst create -v 1.21.8 -l fabric CoolInstance
```
...
```bash
theboyslauncher start CoolInstance
```
...
```bash
theboyslauncher search [<query>] [--kind {versions, fabric, quilt, forge}]
```
