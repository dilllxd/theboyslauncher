...
function App() {
  ...
  const [newProfileNameAutoGenerated, setNewProfileNameAutoGenerated] = useState(true);
  ...
  async function openProfileCreator() {
    ...
    setNewProfileNameAutoGenerated(true);
  ...
  function selectNewProfileVersionType(versionType: MinecraftVersionType) {
    ...
    const nextVersion = options[0]?.id ?? "";
    setNewProfileVersionType(versionType);
    setNewProfileGameVersion(nextVersion);
    if (newProfileNameAutoGenerated) {
      setNewProfileName(defaultProfileNameForVersion(nextVersion, snapshot.profiles));
    }
  }

  function selectNewProfileGameVersion(gameVersion: string) {
    setNewProfileGameVersion(gameVersion);
    if (newProfileNameAutoGenerated) {
      setNewProfileName(defaultProfileNameForVersion(gameVersion, snapshot.profiles));
    }
  }
                  ...
                  <div className="profile-editor" aria-label="New profile editor">
                    <label>
                      ...
                      <input
                        ...
                        onChange={(event) => {
                          setNewProfileNameAutoGenerated(false);
                    ...
                    <label>
                      ...
                      <select
                        ...
                        onChange={(event) => selectNewProfileGameVersion(event.target.value)}
