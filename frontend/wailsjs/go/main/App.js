...
export function CheckInstanceUpdate(arg1) {
  return window['go']['main']['App']['CheckInstanceUpdate'](arg1);
}

export function CheckInstanceUpdates() {
  return window['go']['main']['App']['CheckInstanceUpdates']();
}
...
export function DetectMigration() {
  return window['go']['main']['App']['DetectMigration']();
}
...
export function OpenInstanceDirectory(arg1) {
  return window['go']['main']['App']['OpenInstanceDirectory'](arg1);
}

export function OpenLauncherDirectory() {
  return window['go']['main']['App']['OpenLauncherDirectory']();
}
