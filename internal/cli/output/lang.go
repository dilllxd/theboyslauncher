...
var en = translations{
	...
	"logout.arg.account": "Account to log out (optional, removes all if not specified)",
	"switch.arg.account": "Account to switch to",
	...
	"packwiz":               "Manage packwiz modpacks",
	"packwiz.install":       "Install a packwiz modpack",
	"packwiz.install.arg.name": "Instance name to create",
	"packwiz.install.arg.url": "URL to pack.toml file",
	...
	"start.arg.account":        "Use specific authenticated account",
	...
	"start.arg.nogui":          "Run packwiz installer in nogui mode (no user interaction required)",
	...
	"launcher.description": "A minimal Minecraft launcher with GUI support.",
	"launcher.license":     "Licensed MIT",
	"launcher.copyright":   "Copyright 2024-2025 TheBoysLauncher team. Based on cmd-launcher by telecter",
...
var de = translations{
	...
	"logout.arg.account": "Konto zum Abmelden (optional, entfernt alle wenn nicht angegeben)",
	"switch.arg.account": "Konto zu dem wechseln",
	...
	"packwiz":               "Packwiz Modpacks verwalten",
	"packwiz.install":       "Packwiz Modpack installieren",
	"packwiz.install.arg.name": "Name für die zu erstellende Instanz",
	"packwiz.install.arg.url": "URL zur pack.toml Datei",

	"start":                    "Instanze starten",
	"start.arg.id":             "Instanz zum Starten",
	"start.arg.username":       "Benutzername (Offlinemodus)",
	"start.arg.account":        "Verwende bestimmtes authentifiziertes Konto",
	...
	"start.arg.nogui":          "Packwiz Installer im No-GUI-Modus ausführen (keine Benutzerinteraktion erforderlich)",
	...
	"launcher.description": "Ein minimalisticher Minecraft Launcher mit GUI Unterstützung.",
	"launcher.license":     "MIT-Lizenz",
	"launcher.copyright":   "Copyright 2024-2025 TheBoysLauncher Team. Basierend auf cmd-launcher von telecter",
